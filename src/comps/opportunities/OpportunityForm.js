...
const OpportunityForm = (
    ...
    const [appDeadline, setAppDeadline] = React.useState(opportunity.appDeadline || "");
            ...
            <Grid container spacing={1}>
                ...
                <Grid item>
                    <TextField
                        ...
                        multiline
                        maxRows={10}
                        placeholder={"Summer Youth Employment Program (SYEP) is the nation’s largest youth employment program, connecting NYC youth between the ages of 14 and 24 with career exploration opportunities and paid work experiences each summer. "}
                    />
                </Grid>
            </Grid>
        </div>
