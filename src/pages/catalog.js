        ...
        <div>
            ...
            <div className={classes.layout}>
                <main>
					...
					<OpportunityCard title="Lorem Ipsum Dolor Sit Amet" date="April 7, 2022 - April 8, 2022" opportunityLocation="lorem ipsum 2" cost="100" applicationDeadline={new Date("December 17, 1995 03:24:00")} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit"/>
				</main>
            </div>
        </div>
    )
